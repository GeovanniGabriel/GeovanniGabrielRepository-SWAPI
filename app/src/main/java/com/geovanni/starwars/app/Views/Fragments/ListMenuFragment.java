    ...
    public void onItemSelect(Object item, int action, int position) {
        ...
        switch (menuItem.getName()) {
            case "Films":
                ...
                break;
            case "People":
                changeFragments.replaceMainFragment(PeopleFragment.newInstance(), getString(R.string.people), PeopleFragment.TAG, menuItem.getDetail(), true);
                break;
            case "Planets":
            ...
            case "Starships":
                ...
                break;
            case "Vehicles":
                changeFragments.replaceMainFragment(VehiclesFragment.newInstance(), getString(R.string.vehicles), VehiclesFragment.TAG, menuItem.getDetail(), true);
                break;
            default:
                break;
        }
